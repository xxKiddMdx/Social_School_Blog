...
from socialschoolblog.core.views import core
from socialschoolblog.users.views import users
from socialschoolblog.blog_posts.views import blog_posts
from socialschoolblog.error_pages.handlers import error_pages
